...
export default function NotesPage() {
  ...
  return (
    <div className="flex bg-card h-[calc(100vh-8rem)] min-h-[500px] rounded-[2.5rem] border border-muted/50 overflow-hidden shadow-xl shadow-black/5 animate-in fade-in zoom-in-95 duration-500 isolation-auto">
      {/* Inner Sidebar for Notes */}
      <div className="w-64 md:w-80 bg-background border-r border-muted/50 flex flex-col shrink-0 z-10 transition-all">
